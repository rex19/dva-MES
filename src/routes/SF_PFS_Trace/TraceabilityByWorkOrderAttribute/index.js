...
const TraceabilityByWorkOrderAttributeComponents = ({
  traceabilityByWorkOrderAttribute,
  dispatch,
  location,
  form
}) => {
  //每个table可能不同的变量字段(2)
  const TableModelsData = traceabilityByWorkOrderAttribute
  ...
  console.log('TableComponents-traceabilityByWorkOrderAttribute ', TableModelsData)
  ...
  const handleSearch = (e) => {
    ...
    validateFields((err, values) => {
      if (!err) {
        ...
        dispatch({
          type: `${TableName}/GetWorkOrderInformationByAttributeQuery`,
          payload: Params,
        })
      }
    });
...
export default connect(({ traceabilityByWorkOrderAttribute }) => ({ traceabilityByWorkOrderAttribute }))(Form.create()(TraceabilityByWorkOrderAttributeComponents))
