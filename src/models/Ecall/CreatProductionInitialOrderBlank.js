...
import {
  ...
  addKey
} from 'services/Ecall/creatProductionInitialOrderBlank'
...
export default modelExtend(pageModel, {
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === `/Ecall/CreatProductionInitialOrderBlank`) {
          // dispatch({
          //   type: 'InitQuery',
          //   payload: {
  ...
  effects: {
    ...
    * InitQuery({
      ...
      // console.log('creatProductionInitialOrderBlank-model', GetAllLineNamesForActiveWorkOrderComboxData, GetStationInformationForSetupInformationData)
      // yield put({
      //   type: 'showFormData', payload: {
