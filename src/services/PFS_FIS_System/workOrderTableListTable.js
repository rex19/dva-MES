...
export async function GetWorkOrderInformationForEdit(params) {
  return request({
    url: `${tableName}/${globalConfig.crudApi.GetWorkOrderInformationForEdit}`,
    method: 'post',
    data: params,
  })
}
...
export async function EditWorkOrder(params) {
  return request({
    url: `${tableName}/${globalConfig.crudApi.EditWorkOrder}`,
    method: 'post',
    data: params,
  })
}
