  ...
  const routes = [
    {
      ...
      path: '/wmsSystem/rawMaterialReturnBill',
      models: () => [import('./models/wmsSystem/rawMaterialReturnBill')],
      component: () => import('./routes/wmsSystem/rawMaterialReturnBill/')
    }, {
      ...
      path: '/wmsSystem/finishedProductReturnBill',
      models: () => [import('./models/wmsSystem/finishedProductReturnBill')],
      component: () => import('./routes/wmsSystem/finishedProductReturnBill/')
    }, {
      path: '/wmsSystem/checkList',
      models: () => [import('./models/wmsSystem/checkList')],
      component: () => import('./routes/wmsSystem/checkList/')
    }, {
      path: '/wmsSystem/stockReport',
      models: () => [import('./models/wmsSystem/stockReport')],
      component: () => import('./routes/wmsSystem/stockReport/')
    }, {
